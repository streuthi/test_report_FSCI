---
title: |
    | Data Management Plan for the Study
    | _Do Reputable Open Access Journals Require Open Data Sharing?_ 
author: Principal Investigator - Sarah Christofersen, `r params$insitution` 
...
Firstname Lastname, Principal Investigator, `r params$insitution` 
...
a. All original data, code, or reports produced as part of this project are owned by `r params$insitution`  per its institutional intellectual property policy.
...
A sample of the `doaj_seal.csv` data set is shown below. The complete data set is available in searchable and browseable format as [Annex 9.1](#annex-table) at the end of this document.
...
* 'Data Sharing Policy' (Factor, 6 levels)
    ...
    5. Required, but not explicitly tied to editorial decisions
...
Additionally, the Research Data Storage Facility (RDSF) at `r params$insitution`  will undertake to preserve each of the digital outputs mentioned above, for three years beyond the end of the project. Refreshment of storage media will be scheduled as required
